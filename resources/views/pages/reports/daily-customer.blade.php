...
@section('content')
    <main >
        <div class="breadcrums_area breadcrums">
            <div class="common_pagetitle">New Customers Lending</div>
        ...
        <div class="main_page_title">
            <div class="common_pagetitlebig" style="width: 30%;">New Customers</div>
            <div class="btns_rightimport" style="display: inline-flex">
                <div><strong>Total Customer : </strong><span id="totalCustomers" class="text-danger" style="font-weight: 700;"></span></div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <button type="button" onclick="filterNewCustomerReport();" class="btn btn-block mt-4 rounded-full bg-danger font-medium text-white hover:bg-danger-focus focus:bg-danger-focus active:bg-danger-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                                    Search
                                </button>
                                ...
                                <a id="exportdatahref" href="{{route('adminExportReports',['page'=>'new-customer-report'])}}/?loanreportFilter=none" class="btn btn-info mt-4 text-white"> Export</a> 
                            </div>
...
<script>
    ...
    function resetFilter(){
        ...
        function filterNewCustomerReport()
        {
            ...
            $.post('{{route('filterNewCustomerReport')}}',{
                "_token": "{{ csrf_token() }}",
                fromDate:fromDate,
                kycStatus:kycStatus,
