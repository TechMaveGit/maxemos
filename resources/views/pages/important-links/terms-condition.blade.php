...
@section('content')
    <main>
        <div class="breadcrums_area breadcrums">
            ...
            <div class="common_pagetitle">Terms & Conditions</div>
        ...
        <div class="main_page_title">
            <div class="common_pagetitlebig">Terms & Conditions</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="question_card card">
                        <form id="actionForm" method="post" action="{{route('saveTermsAndConditions')}}">
                            @csrf

                            <div class="form-group">
                                <textarea name="termsAndConditions" id="termsAndConditions" class="form-control" rows="10" ><?=$settings->termsAndConditions?></textarea>
                            </div>
