<?php
    ...
    */
    if(!empty($_POST) && (sizeof($_POST) > 0)){
        ...
        $sqlQry="Insert into pg_transaction_histories set userId='$userId',loanId='$loanId',orderId='$orderId',amount='$amount',transactionDate='$transactionDate',paymentStatus='pending',created_at='$today',updated_at='$today'";
        ...
        */
        ...
        $SALT = SALT;
        $ENV = ENV;    // setup test enviroment (testpay.easebuzz.in).
