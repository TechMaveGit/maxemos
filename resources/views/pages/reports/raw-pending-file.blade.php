...
@section('content')
    <main >
        <div class="breadcrums_area breadcrums">
            <div class="common_pagetitle">Raw Pending Files</div>
            ...
            <div class="flex items-center space-x-4  lg:py-6 breadcrum_right">
                ...
                <ul class="hidden flex-wrap items-center space-x-2 sm:flex">
                    ...
                    <li>Raw Pending Files</li>
                </ul>
            </div>
        </div>

        <div class="main_page_title">
            <div class="common_pagetitlebig" style="width: 30%;">Raw Pending Files</div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <a id="exportdatahref" href="{{route('adminExportReports',['page'=>'raw-pending-files'])}}/?loanreportFilter=none" class="btn btn-info mt-4 text-white"> Export</a> 
                            </div>
