...
@endphp
    <main >
        ...
        <div class="main_page_title">
            ...
            <div class="btns_rightimport">
                ...
                @elseif($pageNameStr == "all-customers-list")
                    <a id="exportdatahref" href="{{route('adminExportReports',['page'=>'all-customers-list'])}}/?loanreportFilter=none" class="btn btn-info mt-4 text-white"> Export Data</a>
        ...
        <section class="filters_table">
            <div class="filters">
                <div class="row">
                    <div class="{{ $pageNameStr == "all-customers-list" ? 'col-md-4' : 'col-lg-7 col-md-12' }} ">
                        <div class="row">
                            ...
                            @endif
                            <div class="{{ $pageNameStr == "all-customers-list" ? 'col-lg-6' : 'col-lg-4' }}">
                                <div class="form-group">
                                    <label class="block">
                                        <span>From</span>
                                        <span class="relative mt-1.5 flex">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <label class="block">
                                ...
                                <select id="kycStatus" name="kycStatus" class="form-select mt-1.5 w-full rounded-full border border-slate-300 bg-white px-4 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                    ...
                    <div class="col-lg-2">
                        <div class="form-group">
                            <label class="block">
                                ...
                                <select id="businessStatus" name="businessStatus" class="form-select mt-1.5 w-full rounded-full border border-slate-300 bg-white px-4 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                                    <option value="0">All Status</option>
                                    <option value="approved">Approved</option>
                                    <option value="pending">Pending</option>
                                    <option value="rejected">Rejected</option>
                                    ...
                                    <div class="mainfrm_box">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <label class="block">
                                                    <span>State</span>
                                                    <select class="form-control form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" name="state" id="state">
                                                        <option value="">Select State</option>
                                                        @if($indianStates)
                                                            @foreach ($indianStates as $kk=>$statein)
                                                                <option <?php if(old('state')==$kk.'_'.$statein){ echo "selected"; } ?> value="{{$kk}}_{{$statein}}">{{$statein}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                ...
                                                <label class="block">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                          <input type="checkbox"  id="skipadddharcheck" name="skipadddharcheck" class="form-check-input" value="1">Skip aadhaar verification api
                                                        </label>
                                                      </div>
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <label class="block">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="checkbox"  id="skippencheck" name="skippencheck" class="form-check-input" value="1">Skip pan number verification api
                                                        </label>
                                                    </div>
                                                </label>
                                            </div>
                                    ...
                                    <div class="mainfrm_box">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <label class="block">
                                                    <span>State</span>
                                                    <select class="form-control form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" name="state" id="stateE">
                                                        <option value="">Select State</option>
                                                        @if($indianStates)
                                                            @foreach ($indianStates as $kk=>$statein)
                                                                <option <?php if(old('state')==$kk.'_'.$statein){ echo "selected"; } ?> value="{{$kk}}_{{$statein}}">{{$statein}}</option>
                                            ...
                                            <div class="col-lg-6">
                                                <label class="block">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                          <input type="checkbox" checked id="skipadddharcheck" value="1" name="skipadddharcheck" class="form-check-input" >Skip aadhaar verification api
                                                        </label>
                                                      </div>
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <label class="block">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" checked  id="skippencheck" value="1" name="skippencheck" class="form-check-input" >Skip pan number verification api
                                                        </label>
                                                    </div>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-lg-6" hidden>
                                                <label class="block">
                                                    ...
                                                    <input id="cibilScoreCu" value="0" name="cibilScoreCu" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="" type="text">
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <label class="block">
                                                    <span>Source Person Mobile Number</span>
                                                    <input id="sourcePersonNumber2" name="sourcePersonNumber" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="" type="text">
                                                </label>
                                            </div>
                                    ...
                                    <div class="mainfrm_box">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6" hidden>
                                                <label class="block">
                                                    <span>Cibil Score</span>
                                                    <input id="cibilScoreCoApp" value="0" name="cibilScoreCoApp" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="" type="text">
                                                </label>
                                            </div>
                                ...
                                <form method="POST" enctype="multipart/form-data" id="kycForm">
                                    ...
                                    <div class="mainfrm_box">
                                        ...
                                        --}}
                                            ...
                                            <div class="col-lg-12 p-4 my-3 bg-light">
                                                <label class="block">
                                                    <span style="font-weight: bold;">Photo of Pan Card Partner 1 (optional)</span><a href="" id="kyc1_pancard_imgV" target="_blank" style="color: blue;display: none;">( Click Here to View )</a>
                                                    <input id="kyc1_pancard_img" name="kyc1_pancard_img" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="" type="file">
                                                </label>
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputEmail11">Email</label>
                                                            <input type="email" class="form-control" id="exampleInputEmail11" name="kyc1_email"   placeholder="Enter email">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputMobile1">Mobile Number</label>
                                                            <input type="text" class="form-control" id="exampleInputMobile1"  name="kyc1_mobile"  placeholder="Enter mobile number">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputGender1">Gender</label>
                                                            <select class="form-control form-select" id="exampleInputGender1" name="kyc1_gender">
                                                                <option value="Male">Male</option>
                                                                <option value="Female">Female</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputAddress1">Address</label>
                                                            <input type="text" class="form-control" id="exampleInputAddress1"  name="kyc1_address"  placeholder="Enter address">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputCity1">City</label>
                                                            <input type="text" class="form-control" id="exampleInputCity1" name="kyc1_city"  placeholder="Enter city">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputState1">State</label>
                                                            <select class="form-control form-select" id="exampleInputState1" name="kyc1_state">
                                                                @foreach ($indianStates as $srt=>$name)
                                                                    <option value="{{$srt}}">{{$name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputPincode1">Pincode</label>
                                                            <input type="text" class="form-control" id="exampleInputPincode1" name="kyc1_pincode"  placeholder="Enter pincode">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12 p-4 my-3 bg-light">
                                                <label class="block">
                                                    <span style="font-weight: bold;">Photo of Pan Card Partner 2 (optional)</span><a href="" id="kyc2_pancard_imgV" target="_blank" style="color: blue;display: none;">( Click Here to View )</a>
                                                    <input id="kyc2_pancard_img" name="kyc2_pancard_img" class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="" type="file">
                                                </label>
                                                <div class="row mb-3">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputEmail2">Email</label>
                                                            <input type="email" class="form-control" id="exampleInputEmail2" name="kyc2_email"   placeholder="Enter email">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputMobile2">Mobile Number</label>
                                                            <input type="text" class="form-control" id="exampleInputMobile2"  name="kyc2_mobile"  placeholder="Enter mobile number">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputGender2">Gender</label>
                                                            <select class="form-control form-select" id="exampleInputGender2" name="kyc2_gender">
                                                                <option value="Male">Male</option>
                                                                <option value="Female">Female</option>
                                                                <option value="Other">Other</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputAddress2">Address</label>
                                                            <input type="text" class="form-control" id="exampleInputAddress2"  name="kyc2_address"  placeholder="Enter address">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputCity2">City</label>
                                                            <input type="text" class="form-control" id="exampleInputCity2" name="kyc2_city"  placeholder="Enter city">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputState2">State</label>
                                                            <select class="form-control form-select" id="exampleInputState2" name="kyc2_state">
                                                                @foreach ($indianStates as $srt=>$name)
                                                                    <option value="{{$srt}}">{{$name}}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label style="margin-bottom:0px;" for="exampleInputPincode2">Pincode</label>
                                                            <input type="text" class="form-control" id="exampleInputPincode2" name="kyc2_pincode"  placeholder="Enter pincode">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <div class="modal fade" id="add_edit_business_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="flex justify-between rounded-t-lg bg-slate-200 px-4 py-3 dark:bg-navy-800 sm:px-5">
                    <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                        ...
                        <div class="myContainer">
                                <div class="form-container animated">
                                    ...
                                    <form method="POST" id="professionalDetailsFrm" enctype="multipart/form-data">
                                        <input type="hidden" name="recordId" id="professionalUserId" class="recordId" value="">
                                        @csrf
                                        <div class="mainfrm_box">
                                            <div class="row" >
                                                <div class="col-lg-6">
                                            ...
                                            <div id="professionalDetailsHtml"></div>
                                        </div>
                                        <div class="form-group text-right mar-b-0 nextbtn_brx" style="display: none;">
                                        ...
                                        <div class="form-group text-right mar-b-0" style="margin-top: 10px;">
                                            <!--<input type="button" value="BACK" class="btn btn-default back btn min-w-[7rem] rounded-full border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">-->
...
<script>
    function filterUsersCustomerManagement()
    {
        ...
        url.searchParams.set("kycStatus", kycStatus);
        url.searchParams.set("businessStatus", businessStatus);
...
<script>
        ...
        $.post('{{route('getUserAllDetails')}}',{
            ...
            if(obj.status=='success')
            {
                ...
                if(obj.user)
                {
                    ...
                    $('#stateE').val(obj.user.state_short+'_'+obj.user.state);
                    ...
                    $('#sourcePersonNumber2').val(obj.user.sourcePersonNumber);
                ...
                */
                ...
                if(obj.loanKyc1){
                    $("#exampleInputEmail11").val(obj.loanKyc1.email);
                    $("#exampleInputMobile1").val(obj.loanKyc1.mobile);
                    $("#exampleInputGender1").val(obj.loanKyc1.gender);
                    $("#exampleInputAddress1").val(obj.loanKyc1.addressLine1);
                    $("#exampleInputCity1").val(obj.loanKyc1.city);
                    $("#exampleInputState1").val(obj.loanKyc1.state_short);
                    $("#exampleInputPincode1").val(obj.loanKyc1.pincode);

                    if(obj.loanKyc1.pancard_img){
                        $('#kyc1_pancard_imgV').attr('href','{{asset('/')}}public/'+obj.loanKyc1.pancard_img);
                        $('#kyc1_pancard_imgV').show();
                    }else{
                        $('#kyc1_pancard_imgV').hide();
                    }
                }

                if(obj.loanKyc2){
                    $("#exampleInputEmail2").val(obj.loanKyc2.email);
                    $("#exampleInputMobile2").val(obj.loanKyc2.mobile);
                    $("#exampleInputGender2").val(obj.loanKyc2.gender);
                    $("#exampleInputAddress2").val(obj.loanKyc2.addressLine1);
                    $("#exampleInputCity2").val(obj.loanKyc2.city);
                    $("#exampleInputState2").val(obj.loanKyc2.state_short);
                    $("#exampleInputPincode2").val(obj.loanKyc2.pincode);

                    if(obj.loanKyc2.pancard_img){
                        $('#kyc2_pancard_imgV').attr('href','{{asset('/')}}public/'+obj.loanKyc2.pancard_img);
                        $('#kyc2_pancard_imgV').show();
                    }else{
                        $('#kyc2_pancard_imgV').hide();
                    }
                }
    ...
    function getBusinessOrCompanyDetails(isBusiness)
    {
        var userId=$('#professionalUserId').val();
        if(!parseInt(userId)){
            alertMessage('Error!', 'Invalid Request, Please try again.', 'error', 'no');
            return false;
        }
        
        $.post('{{route('getBusinessOrCompanyDetails')}}',{
            "_token": "{{ csrf_token() }}",
            userId:userId,
            isBusiness:isBusiness,
            pageNameStr:'{{$pageNameStr}}'
        },function(data){
            $('#professionalDetailsHtml').html(data);
    ...
    function editCustomerBusiness(userId)
    {
        $('#professionalUserId').val(userId);
        $('#add_edit_business_modal').modal('show');
    }
    ...
    $('#personalFormEdit').submit(function(e) {
        ...
        var sourcePersonNumber2=$('#sourcePersonNumber2').val();
        var branchName2=$('#branchName2').val();

        var newdateOfBirthECoApp=checkDOB($('#dateOfBirthE').val());
        ...
        if(!nameTitleCu) {
            ...
            alertMessage('Error!', 'Please select date of birth.', 'error', 'no');
            return false;
        }else if(newdateOfBirthECoApp<21 || newdateOfBirthECoApp>58){    
            ...
            return false;
        }else if(!sourcePersonNumber2) {
            alertMessage('Error!', 'Please enter source person mobile number.', 'error', 'no');
            return false;
        }else if(!branchName2) {
    ...
    $('#personalFormCoApplicantEdit').submit(function(e) {
        ...
        var newdateOfBirthECoApp=checkDOB($('#dateOfBirthECoApp').val());
    ...
    $('#professionalDetailsFrm').submit(function(e) {
        ...
        if(!employerName) {
            ...
            return false;
        } else if(isBusiness=='1' && !companyPan) {
            alertMessage('Error!', 'Please enter pan number.', 'error', 'no');
            return false;
        } else if(isBusiness=='1' && companyPan && companyPan.length!=10) {
            alertMessage('Error!', 'Please enter valid pan number.', 'error', 'no');
            return false;
        }else if(isBusiness=='1' && !companyGstin) {
            alertMessage('Error!', 'Please enter GSTIN.', 'error', 'no');
            return false;
        }else if(isBusiness=='1' && companyGstin && companyGstin.length!=15) {
            alertMessage('Error!', 'Please enter valid GSTIN.', 'error', 'no');
            return false;
        } else if(!companyType) {
            alertMessage('Error!', 'Please select company type.', 'error', 'no');
            return false;
        } else if(isBusiness=='0' && !totalExpInCurrentCompany) {
            alertMessage('Error!', 'Please enter total experience in current company.', 'error', 'no');
            return false;
        } else if(isBusiness=='0' && !currentSalary) {
            alertMessage('Error!', 'Please enter current salary.', 'error', 'no');
            return false;
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    if(obj.status=='success')
                    {
                        getBusinessOrCompanyDetails(isBusiness);
                        alertMessage('Success!', obj.message, 'success', 'no');
                        return false;
                    }else{
                        alertMessage('Error!', obj.message, 'error', 'no');
    ...
    //TODO AJAX KYC Documents Upload
