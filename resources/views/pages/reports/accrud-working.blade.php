...
<main >
    <div class="breadcrums_area breadcrums">
        <div class="common_pagetitle">Accrud Working Report</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label class="block">
                                    <span>Quarterly</span>
                                    <select id="quarterlyFilter" class="form-select mt-1.5 w-full rounded-full border border-slate-300 bg-white px-4 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                                        @if($output)
                                        @foreach($output as $mdata)
                                            <option value="{{$mdata}}">{{$mdata}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </label>
                        ...
                        <div class="col-md-2 text-right">
                            <a id="exportdatahref" href="{{route('adminExportReports',['page'=>'accrud-working'])}}/?loanTypereportFilter=none" class="btn btn-info mt-4 text-white"> Export Data</a> 
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="table_mainstart">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div>
                        <h6><strong class="text-danger">Note</strong> : Only Raw Material Financing Loan Data Not Inculded In All Loan Type Filter.</h6>
                        <div class="card mt-3">
...
<script>
    ...
    function filterPaymentReports()
    {
        ...
        $.post('{{route('filterAccrudWorkingReports')}}',{
            "_token": "{{ csrf_token() }}",
            loanTypereportFilter:loanTypereportFilter,
            quarterlyFilter:quarterlyFilter,
        },function (data){
