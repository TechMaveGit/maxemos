...
background-position-y: -300px;
                ...
                <div class="col-lg-6">
                      <div class="bannerinner__details">
                        <div class="gredient_heading">
                          ...
                          <h1>Receivables Invoicing</h1>
                          <p>A receivables invoicing loan, also known as invoice factoring or accounts receivable financing, is a type of funding that allows businesses to obtain immediate cash for their outstanding invoices.</p>
   ...
   <div class="obelisk-image obelisk-tooltip style-1">
      <div class="img sizxl" data-tooltip-tit="Digital Marketing" data-tooltip-sub="Agency ">
         <img src="{{asset('assets/web')}}/asset/img/newimages/receivables-loan.jpeg" alt="" class="imago wow animated" style="visibility: visible;">
      </div>
   </div>
</div>
...
<div class="bannercustom__container">
    <section class="about_loan_sec">
          <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1>Know about Receivables Invoicing </h1>
         ...
         <p>The basic process of a receivables invoicing loan involves a lender purchasing a company's outstanding invoices. The lender then assumes the responsibility of collecting payment from customers and pays back the company the remaining balance of the invoice after deducting fees and interest.</p>
         <p><strong>Businesses can benefit from receivables invoicing loans in several ways.</strong></p>
         <p>Firstly, it provides them with fast access to cash, which is crucial in meeting their financial obligations, such as paying employees, vendors, and other bills. </p>
         <p>Secondly, the company can reduce the risk of bad debts and unpaid invoices as the lender assumes responsibility for collecting payments from customers. It also saves valuable time and costs associated with collection efforts.</p>
    ...
    <section class="loan_benefits">
          <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="loan_innersec_heading">
                    <h1>Receivables Invoicing Benefits</h1>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="prelements-heading style4">
                        ...
                        <div class="title-inner"><h2 class="title"><span class="watermark"></span>Receivables Invoicing</h2></div>
                ...
                <div class="col-md-8 col-lg-9">
                    ...
                    <div class="services-details">
                        ...
                        <div class="services-thumb-lg">
                            ...
                            <img src="{{asset('assets/web')}}/asset/img/newimages/reciable-loan.jpg" alt="">

                        </div>

                        <h2 class="title_details">Receivables Invoicing</h2>
                        ...
                        <div class="single-sidebar">
                            ...
                            <div class="services">
                                ...
                                <li><a href="{{route('WebBusinessLoan')}}"><i class="fa fa-long-arrow-right"></i>Business Loan</a></li>
                                    ...
                                    <li><a href="{{route('WebReceivableLoan')}}" class="active__tab"><i class="fa fa-long-arrow-right"></i>Receivables Invoicing</a></li>
